...
class Department {
  constructor(
    public readonly id: number,   // cannot be changed
    public name: string,          // accessible everywhere
    protected employees: string[] = [] // accessible in child classes
  ) {}
...
const it = new ITDepartment(1, ["Alex", "John"]);

it.addEmployee("Sashanka");
it.addEmployee("Lucky");

it.describe();        // inherited method
it.showAdmins();      // child method
it.showEmployees();   // protected access


//! Override Properties And Protected accessModifier
